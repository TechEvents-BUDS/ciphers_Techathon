...
# Take patient's name and age as input
patient_name = input("Please enter the patient's name: ")
patient_age = input("Please enter the patient's age: ")
...
while True:
    ...
    if len(faces) > 0 and not face_detected:
        face_detected = True
        print(f"Face detected for {patient_name} (Age: {patient_age})! Attendance recorded.")
